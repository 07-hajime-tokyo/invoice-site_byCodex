 ...
 * partnerNames は表示名の配列（初期値: サミー, ルカ, サイモン, マキシム, ネレ）。
...
export type ClassifyInboundInput = {
  ...
  /** 直取の相手名リスト（表示名。初期値: サミー, ルカ, サイモン, マキシム, ネレ。設定で追加可能） */
...
export const DEFAULT_DIRECT_PARTNER_NAMES: readonly string[] = ["サミー", "ルカ", "サイモン", "マキシム", "ネレ"] as const;
